// ...existing code...
// Animated Download Button Functionality (replaced with robust handler)
(function() {
  // const FILE_URL = './assets/atharvacv.pdf';
  // const FILE_NAME = 'atharvacv.pdf';

  const FILE_URL='';
  const FILE_NAME='';

  // function triggerDownload(url, filename) {
  //   // Try fetch -> blob download (works on served sites)
  //   fetch(url)
  //     .then(res => {
  ...
  //     })
  //     .catch(err => {
  //       console.warn('Download fallback, opening file in new tab:', err);
  //       // Fallback: open file directly (user can save from new tab)
  //       window.open(url, '_blank');
  //     });
  // }

  // document.addEventListener('DOMContentLoaded', function() {
  //   // checkbox-based animated download (existing UI)
  //   const downloadCheckbox = document.querySelector('.download-label .download-input');
  //   if (downloadCheckbox) {
  //     downloadCheckbox.addEventListener('change', function() {
  //       if (this.checked) {
  //         // allow animation to start
  //         setTimeout(() => triggerDownload(FILE_URL, FILE_NAME), 500);
  //         // reset checkbox after animation finishes
  //         setTimeout(() => { this.checked = false; }, 4500);
  //       }
  //     });
  //   }

  //   // button/link fallback: id="downloadBtn" or class .download-btn or .download-link
  //   const downloadBtn = document.getElementById('downloadBtn') || document.querySelector('.download-btn') || document.querySelector('.download-link');
  //   if (downloadBtn) {
  //     downloadBtn.addEventListener('click', function(e) {
  //       e.preventDefault();
  //       triggerDownload(FILE_URL, FILE_NAME);
  //     });
  //   }
  // });
})();
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // ================= PROJECTS PARTICLES =================
  const projectsParticles = document.getElementById("particles-projects");
  if (projectsParticles && typeof particlesJS !== "undefined") {
